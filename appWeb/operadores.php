  ...
  <div class="tabla">
    ...
    <table>
        ...
        <tr>
         ...
         <th><a href="registroOperadores.php"><button>Registrar</button></a></th>
    ...
    ?>
       ...
       <td><a href="editarOperador.php?id=<?php echo $columna[0];?>"><button>Editar</button></a>
          <a href="modelo/eliminarOperadores.php?id=<?php echo $columna[0];?>"><button>Borrar</button></a></td>
